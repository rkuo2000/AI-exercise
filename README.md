...
#### `code` [Reasoning from scratch](https://github.com/rasbt/reasoning-from-scratch) [YouTube](https://youtu.be/831MHlz4YrU)
`slide` [From Foundations to Reasoning Models](https://sebastianraschka.com/pdf/slides/2025-04-llms-whats-next.pdf)
